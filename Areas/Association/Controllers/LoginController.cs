    ...
    public class LoginController : Controller
    {
        ...
        public IActionResult Index(LoginViewModel loginViewModel)
        {
            try
            {
                ...
                else if (Hashpassword.Verify(loginViewModel.Password, phoneUser.User.Password) && phoneUser.User.JobName == "جمعية" && phoneUser.User.Status != "متوقف")
                {
                    HttpContext.Session.Clear();
                    HttpContext.Session.SetString("_AssUserId", phoneUser.User.Id.ToString());
